<!-- include-file(licence.txt) -->
<!-- struct-template(template-services-fr.md) -->

<!-- var(nom-variable)="Valeur" -->
<!-- var(lang)="Valeur" -->
<!-- var(version)="Valeur" -->
<!-- var(date-update)="Valeur" -->
<!-- var(title)="Valeur" -->
<!-- var(author)="$author$" -->
<!-- var(author)="$author$" -->
...
Date de mise à jour : <!-- begin-var(date-update) -->texte misà jour<!-- end-ref     -->
