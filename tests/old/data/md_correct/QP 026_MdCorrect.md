026. ANIMATEUR D’ÉQUITATION (ANIMATEUR SPORTIF)**
==================

1°. Définition de l’activité**

L’animateur d’équitation (aussi appelé animateur d’activités équestres) prépare et met en œuvre des activités d’initiation, d’animation et d’enseignement équestre. Il accompagne également la préparation aux premiers niveaux de compétition dans la mention qu’il a choisie (équitation, western, attelage, etc.). Il participe à l’entretien des chevaux (et autres animaux associés) ainsi qu’à la maintenance des installations et du matériel à disposition. Il assure la sécurité des pratiquants qu’il encadre et intervient auprès d’un public varié (des enfants aux seniors).

*Pour aller plus loin* : arrêté du 28 juin 2003 portant création de la spécialité activités équestres du brevet professionnel de la jeunesse, de l’éducation populaire et du sport.
...
Le BPJEPS spécialité « activités équestres » est un diplôme de niveau IV, c’est-à-dire niveau baccalauréat. Il atteste de la possession de compétences professionnelles indispensables à l’exercice du métier d’animateur dans le champ de la spécialité concernée.
...
Le BPJEPS spécialité « activités équestres » est composé de plusieurs mentions, au choix du candidat (qui peut aussi les cumuler s’il le souhaite) :
...
###### Conditions d’accès à la formation menant à l’obtention du BPJEPS spécialité « activités équestres », quelle(s) que soi(en)t la / les mention(s) choisie(s)


 - être majeur ;
 - être titulaire d’une attestation de formation aux premiers secours (PSC1 ou son équivalent) ;
 - réussir les épreuves d’admission au sein de l’organisme de formation ;
 - produire un certificat médical de non contre-indication à la pratique des activités équestres, datant de moins de trois mois à la date d’entrée en formation ;
 - produire une attestation de réussite aux exigences préalables liées au niveau de pratique équestre professionnelle**. Ces exigences varient selon la mention envisagée :**
 - pour la mention équitation : présenter un cheval ou un poney D sur le plat sur la reprise définie, puis sur un parcours défini et enfin à la longe ou aux longues rênes,
 - pour la mention tourisme équestre : présenter un cheval ou un poney D sur un parcours défini en terrain varié, puis sur un parcours d’orientation défini et enfin sur à la longe ou aux longues rênes,
 - pour la mention équitation western : présenter un cheval ou un poney D sur une reprise de dressage combinée western à deux mains définie, puis sur un parcours de reining à deux mains défini et enfin présenter en main un cheval ou un poney,
 - pour la mention équitation de tradition et de travail : présenter un cheval ou un poney D sur une reprise d’équitation de tradition définie, puis sur un test de maniabilité défini et enfin sur un test de tri du bétail défini,
 - pour la mention attelage : présenter un cheval ou un poney D attelé sur une reprise combinée définie incluant dressage et maniabilité puis présenter l’animal monté sur le plat sur la reprise définie et enfin présenter l’animal non attelé aux longues guides.

Pour plus de précisions quant aux exigences préalables liées au niveau de pratique professionnelle, il est conseillé de se reporter à la circulaire n°DS/DSC1/2012/149 du 1er avril 2012.

Certains organismes de formation peuvent exiger la communication d’autres documents lors de l’inscription (une attestation de recensement par exemple). Pour plus d’informations, il est conseillé de se rapprocher de l’organisme de formation concerné.

La formation à la profession d’animateur d’équitation dure environ douze mois et s’effectue le plus souvent en alternance.

*Pour aller plus loin* : arrêté du 28 juin 2003 portant création de la spécialité « activités équestres » du brevet professionnel de la jeunesse, de l’éducation populaire et du sport et ses annexes et la circulaire n°DS/DSC1/2012/149 du 1er avril 2012 relative à la mise en œuvre de la spécialité « activités équestres » du brevet professionnel de la jeunesse, de l’éducation populaire et du sport.

###### À savoir
Le titulaire du BPJEPS spécialité « activités équestres » peut élargir ses prérogatives en passant différents certificats de spécialisation (CS) tels que les CS « accompagnement et intégration des personnes en situation de handicap », « animation et insertion sociale », « course d’orientation » ou « environnement numérique et réseaux ». [Plus d’informations](http://www.sports.gouv.fr/emplois-metiers/decouvrir-nos-offres-de-formations/BPJPES/Reglementation-11011/Les-certificats-de-specialisation/) sur les conditions d’obtention de ces certificats de spécialisation.

#### Coûts associés à la qualification

La formation menant à l’obtention du BPJEPS spécialité « activités équestres » est payante. Son coût varie entre 4 500 et 8 000 euros environ. Pour [plus de précisions](http://foromes.calendrier.sports.gouv.fr/#/formation), il est conseillé de se rapprocher du centre de formation considéré.
...
Il est interdit d’exercer en tant qu’animateur d’activités équestres en France pour les personnes ayant fait l’objet d’une condamnation pour tout crime ou pour l’un des délits suivants :
