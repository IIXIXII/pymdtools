022. ANIMATEUR D’ACTIVITÉS NAUTIQUES (ANIMATEUR SPORTIF)**
==================

1°. Définition de l’activité**

L’animateur d’activités nautiques assure l’animation, la découverte, l’initiation et l’apprentissage, incluant les premiers niveaux de compétition, de disciplines variées : char à voile, canoë-kayak, voile, aviron, glisses aérotractées, parachutisme ascensionnel nautique, croisière, etc. Il veille à la sécurité du public dont il a la charge (des jeunes enfants aux seniors), ainsi qu’à l’entretien du matériel.
...
L’activité d’animateur est régie par les articles L. 212-1 et suivants du code du sport qui exigent l’obtention de certifications parmi lesquelles figure le brevet professionnel de la jeunesse, de l’éducation populaire et du sport (BPJEPS).
...
Le BPJEPS spécialité « activités nautiques » est un diplôme de niveau IV, c’est-à-dire niveau baccalauréat. Il atteste de la possession de compétences professionnelles indispensables à l’exercice du métier d’animateur dans le champ de la spécialité concernée.

Le BPJEPS spécialité « activités nautiques » est composé de plusieurs mentions, au choix du candidat. Si le candidat n’en sélectionne qu’une lors de sa formation, il prépare un BPJEPS monovalent. Dans le cas où il en choisit deux (ou plus), il effectue un BPJEPS plurivalent.

**Mentions monovalentes du BPJEPS spécialité « activités nautiques »** (dans le cas où le candidat souhaite préparer un BPJEPS monovalent, il doit choisir l’une de ces mentions) :
...
**Mentions plurivalentes du BPJEPS spécialité « activités nautiques »** (dans le cas où le candidat souhaite préparer un BPJEPS plurivalent, il doit choisir plusieurs mentions faisant partie de groupes différents) :

 - groupe A : aviron de mer, aviron d’initiation ;
...
Dans tous les cas, le BPJEPS spécialité « activités nautiques » peut être obtenu par la voie de la formation professionnelle continue, de l’apprentissage ou de la validation des acquis de l’expérience (VAE). Pour plus d’informations, vous pouvez consulter le [site officiel]( http://www.vae.gouv.fr/) de la VAE.

###### Conditions d’accès à la formation menant à l’obtention du BPJEPS spécialité « activités nautiques », quelle(s) que soi(en)t la / les mentions choisie(s)
 ...
 - produire un certificat médical de non contre-indication à la pratique des activités nautiques, datant de moins de trois mois à la date d’entrée en formation ;
 - produire une attestation de réussite, délivrée par un maître nageur-sauveteur, à un parcours de 100 mètres nage libre, départ plongé et récupération d’un objet immergé à 2 mètres de profondeur ;
 - satisfaire aux tests d’exigence préalable dont le contenu, qui varie selon la ou les mentions choisies, est précisé à l’annexe III de l’arrêté du 9 juillet 2002.
...
Sous certaines conditions, il est possible d’obtenir des dispenses pour certaines épreuves. Pour plus d’informations, il est conseillé de se référer à l’arrêté du 9 juillet 2002 précité ainsi qu’à ses annexes.

La formation à la profession d’animateur d’activités nautiques s’effectue le plus souvent en alternance et dure dix-huit mois environ.

*Pour aller plus loin* : arrêté du 9 juillet 2002 portant création de la spécialité activités nautiques du brevet professionnel de la jeunesse, de l’éducation populaire et du sport et article L. 212-2 du code du sport.

###### À savoir
Le titulaire du BPJEPS spécialité « activités nautiques » peut élargir ses prérogatives en passant différents certificats de spécialisation (CS). Parmi eux, on peut citer pour exemple : le CS « accompagnement et intégration des personnes en situation de handicap », « animation et insertion sociale », « cerf-volant », « croisière », etc. [Plus d’informations](http://www.sports.gouv.fr/emplois-metiers/decouvrir-nos-offres-de-formations/BPJPES/Reglementation-11011/Les-certificats-de-specialisation/) sur les conditions d’obtention de ces certificats de spécialisation.

#### Coûts associés à la qualification

La formation menant à l’obtention du BPJEPS spécialité « activités nautiques » est payante. Son coût varie entre 5 000 et 8 000 euros environ. Pour [plus de précisions](http://foromes.calendrier.sports.gouv.fr/#/formation), il est conseillé de se rapprocher du centre de formation considéré.
...
Il est interdit d’exercer en tant qu’animateur d’activités nautiques en France pour les personnes ayant fait l’objet d’une condamnation pour tout crime ou pour l’un des délits suivants :
