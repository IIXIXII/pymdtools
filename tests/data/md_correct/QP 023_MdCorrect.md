023. ANIMATEUR D’ACTIVITÉS PHYSIQUES POUR TOUS (ANIMATEUR SPORTIF)**
==================

1°. Définition de l’activité**

L’animateur d’activités physiques pour tous encadre et anime contre rémunération, à titre d’occupation principale ou secondaire, de façon habituelle, saisonnière ou occasionnelle, des prestations visant au développement et au maintien de capacités physiques individuelles dans un objectif de santé et de bien-être. Il participe à la découverte et à l’initiation d’activités physiques ou sportives diversifiées pour tous types de publics sans viser le perfectionnement, la compétition ou la spécialisation dans une activité.
...
Les diplômes étrangers peuvent être admis en équivalence aux diplômes français par le ministre chargé des sports, après avis de la commission de reconnaissance des qualifications placée auprès de ministre.

*Pour aller plus loin* : articles L. 212-1, R. 212-84 et D. 212-11 et suivants du code du sport.

#### Formation

Le BPJEPS spécialité « activités physiques pour tous » (APT) est classé niveau IV, c’est-à-dire niveau baccalauréat. Il atteste de la possession de compétences professionnelles indispensables à l’exercice du métier d’animateur dans le champ de la spécialité concernée.
...
###### Conditions d’accès à la formation menant à l’obtention du BPJEPS spécialité « activités physiques pour tous »


 - être majeur ;
 - être titulaire d’une attestation de formation aux premiers secours (type PSC1) ;
 - produire un certificat médical de non contre-indication à la pratique des activités physiques et sportives, datant de moins de trois mois à la date d’entrée en formation ;
 - communiquer une attestation, délivrée par le directeur régional de la jeunesse, des sports et des loisirs ou par un expert désigné par ses soins, de réussite aux exigences préalables liées à la pratique sportive du candidat**. Ces exigences sont évaluées au moyen :**
 - d’un test d’endurance dit « test Luc Léger » pour lequel les hommes doivent atteindre au moins l’annonce du palier 7 et les femmes celle du palier 5,
 - d’un test d’habileté motrice dont le détail est précisé par l’arrêté du 24 février 2003,
...
**À noter** : le titulaire du BPJEPS spécialité « activités physiques pour tous » peut élargir ses prérogatives en passant un certificat de spécialisation (CS). Il existe notamment, à titre d’exemple, les CS « activités athlétiques », « activités d’escalade », « course d’orientation », « roller », « tennis de table », « tir à l’arc », etc. Pour plus d’informations concernant les conditions d’obtention de ces CS, il est conseillé de se référer au [site officiel] ( [*http://www.sports.gouv.fr/emplois-metiers/decouvrir-nos-offres-de-formations/BPJPES/Reglementation-11011/Les-certificats-de-specialisation/*](http://www.sports.gouv.fr/emplois-metiers/decouvrir-nos-offres-de-formations/BPJPES/Reglementation-11011/Les-certificats-de-specialisation/)) du ministère des sports.

###### Bon à savoir
Pour encadrer un public composé de personnes en situation de handicap, le titulaire du BPJEPS « activités physiques pour tous » a l’obligation de disposer du CS « accompagnement et intégration des personnes en situation de handicap ». Pour plus d’informations, il est conseillé de se reporter aux fiches « Animateur handisport » et « Animateur de sport adapté ».

#### Coûts associés à la qualification

La formation menant à l’obtention du BPJEPS spécialité « activités physiques pour tous » est payante. Son coût varie 4 500 et 8 000 euros environ. Pour [plus de précisions](http://foromes.calendrier.sports.gouv.fr/#/formation), il est conseillé de se rapprocher du centre de formation considéré.
...
Il est interdit d’exercer en tant qu’animateur d’activités physiques pour tous en France pour les personnes ayant fait l’objet d’une condamnation pour tout crime ou pour l’un des délits suivants :
...
### b. Déclaration préalable d’activité pour les ressortissants de l’UE en vue d’un exercice permanent (LE)
